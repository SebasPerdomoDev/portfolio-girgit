...
import headerImg from "../assets/img/GirGit.png";
...
export const Banner = () => {
  ...
  const toRotate = [ "Desarrollo Web", "Plataformas Web", "Software y más" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <a href="https://wa.me/573134800728" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
